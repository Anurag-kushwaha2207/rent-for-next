...
interface SignUpProps {
  onBack: () => void;
  onSignUp: (data: { fullName: string; mobile: string; email: string; password: string }) => void;
}

export default function SignUp({ onBack, onSignUp }: SignUpProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/20 backdrop-blur-lg rounded-2xl p-8 border border-white/30 shadow-2xl">
          ...
          <h2 className="text-white text-center mb-6">Create Your Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit"
              className="w-full bg-white text-purple-600 hover:bg-white/90 h-12 mt-6"
            >
              Sign Up
            </Button>
          </form>
